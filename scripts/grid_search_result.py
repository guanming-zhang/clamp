...
import csv
import re
root_dir = "/home/richard/HPC-Scratch/sig-ml/clap/simulations/cifar10/resnet18/linear/grid_search_view_weight"
...
for folder in folders:
    ...
    csv_line = [dir_num,ssl_lr,ssl_bs,rs,lw0,lw2,momentum,n_views,pot_pow,test_acc1,test_acc5]
